...
async function visualizaDadosGlobais(){
    ...
    paragrafo.innerHTML = `O mundo tem ${totalPessoasMundo} bilhoẽs de habitantes, 
    dos quais ${totalPessoasConectadas} bilhoẽs estão conectados em alguma rede social 
